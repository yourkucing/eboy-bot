...
if (command === 'search') {
 ...
 if (msg.content === '@eboy help' || command === 'help' || command === 'command' || command === 'commands') {
		...
		{ name: 'uwu <commands> @<username>', value: '`bite`, `boop`, `cling`, `console`, `defenestrate`, `delete`, `drag`, `hug`, `kick`, `kill`, `kiss`, `love`, `patpat`, `peck` (aka peck on the cheeks), `punch`, `scold`, `shake`, `shoot`, `slap`, `snuggle`, `stab`, `summon`, `tackle`, `tonk`, `untonk`, `yeet`' },
		{ name: 'uwu <commands>', value: '`angry`, `cheer`, `clap`, `confused`, `cry`, `dance`, `die`, `eat`, `ew`, `hide`, `hydrate`, `jitter`, `laugh`, `scream`, `sleep`, `spazz`, `tantrum`, `work`, `yoink`' },
