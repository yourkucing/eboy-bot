...
module.exports.run = async(client, msg, args) => {
    ...
    msg.channel.send(`\`He stared up at the House of Doom, gulping as he noticed the mist and darkness surrounding it. But he had no choice, did he? After all, the kitten of his life was inside. His poor Amy. With a heft of his backpack, Liam strode into the house with a sense of purpose. Find Amy and get out.\`
...
\`Make your choice, buddy. Choose fast, you only have 10 mins!\``).then(msg => {
        msg.react('➡️').then(message => {
            ...
            right.on('collect', (reaction, user) => {
                msg.channel.send(`\`He walked towards the door, trying to turn its knob. Surprisingly, it's unlocked! With quiet footsteps, he wandered into the room— and stopped cold in his tracks. What's this? A letter addressed to him? He picked it up and read its contents.\``)
                msg.channel.send(`*Hi buddy,\nAre you looking for Amy? Don't worry, she's fine actually. I mean, other than the fact that she keeps meowing for you. You must be an amazing pet owner, I don't doubt that. But anyway, I just wanted to take this time to tell you that you are:\n\nClever: you are. i mean, the way your mind works, i'm always impressed.\nOrganised: have you seen yourself when taking charge of everything? You're one of my role models.\nDorky: the way you spazz about your own artwork is adorable as hell.\nEasy-going: i love being able to talk to you sometimes, it makes me feel comfortable and you're always fun to talk to.
                
Anyway, that's pretty much it. I should be nicer, I guess. That's what everyone always says. There is a small room behind the mirror, but there's a code. You gotta put on your thinking CAPS. But I have faith in you.*`)
                msg.channel.send(`\`He frowned and walked towards the mirror. He swore he could hear a short meow from behind the mirror. Pushing it aside, sure enough, there was a door. But there's a code too. Now what could it be?\`
